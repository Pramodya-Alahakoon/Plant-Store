...
import com.example.botaniq.adapters.HerbsPlantAdapter
import com.example.botaniq.data.HerbsPlantsData
import com.example.botaniq.models.HerbsPlant
import com.google.android.material.chip.Chip
import com.google.android.material.chip.ChipGroup
import com.google.android.material.snackbar.Snackbar

class HerbsEdiblesActivity : AppCompatActivity() {

    private lateinit var plantAdapter: HerbsPlantAdapter
    private lateinit var recyclerView: RecyclerView
    private lateinit var searchEditText: EditText
    private lateinit var filterChipGroup: ChipGroup

    private val plants = HerbsPlantsData.getPlants()
    private var filteredPlants = mutableListOf<HerbsPlant>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_herbs_edibles)
    ...
    private fun setupRecyclerView() {
        plantAdapter = HerbsPlantAdapter(
        ...
        recyclerView.apply {
            layoutManager = GridLayoutManager(this@HerbsEdiblesActivity, 2)
    ...
    private fun filterPlants() {
        ...
        filteredPlants.addAll(plants.filter { plant ->
            ...
            val matchesFilter = if (selectedFilters.isEmpty()) {
                ...
                selectedFilters.any { filter -> plant.category == filter || plant.tags.contains(filter) }
            }
    ...
    private fun handlePlantClick(plant: HerbsPlant) {
        // Navigate to plant detail activity
    }

    private fun handleFavoriteClick(plant: HerbsPlant) {
    ...
    private fun handleAddToCartClick(plant: HerbsPlant) {
        Snackbar.make(
            recyclerView,
